...
public class InitController {
    ...
    public InitController(UserRepository userRepository, UserService userService,
                          HttpHandler requestHandler, VideoService videoService) {
    ...
    public void init() {
        ...
        admin.setPassword(defaultServerPassword);
